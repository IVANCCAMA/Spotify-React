...
function ListaCancionesUser() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        let responseCanciones; 
        // verificar si esta logeado el user
        responseCanciones = await axios.get(`https://spfisbackend-production.up.railway.app/api/canciones/completo_lista_oyente/${id_lista}`);
...
export default ListaCancionesUser;
